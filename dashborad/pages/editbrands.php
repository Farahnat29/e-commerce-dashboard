          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <form role="form" action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                  <input type="text" name="id" id="id" value="<?php echo isset($row['id']) ? $row['id'] : ''; ?>" class="form-control form-control-lg" placeholder="ID">
                </div>
                <div class="mb-3">
                  <input type="text" name="name" id="name" value="<?php echo isset($row['name']) ? $row['name'] : ''; ?>" class="form-control form-control-lg" placeholder="Name">
                </div>
                <div class="mb-3">
                  <input type="file" name="img" id="img" class="form-control form-control-lg">
                </div>
                <div class="mb-3">
                  <input type="text" name="status" id="status" value="<?php echo isset($row['status']) ? $row['status'] : ''; ?>" class="form-control form-control-lg" placeholder="Status">
                </div>
